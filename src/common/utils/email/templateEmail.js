import { FACEBOOK, INSTAGRAM, YOUTUBE } from "../../../../config/config.js"

export const emailTemplate = async ({ code, title = 'confirmEmail' } = {}) => {
    return `<!DOCTYPE html>
                <html>
                <head>
                ...
                <a href="${YOUTUBE}" style="text-decoration: none;"><span class="twit" style="padding:10px 9px;;color:#fff;border-radius:50%;">
...
export const createCodeOtp = async () => {
